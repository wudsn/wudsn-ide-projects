;       WUDSN IDE example ASM6 source file for NES
;
;       Based on https://github.com/nicklausw/hello-nes
...
message:
.db "HELLO WORLD"-$36,$ff


; Dummy interrupte vector routine
dummy: rti
...
; Font starts at $10000
.incbin "HelloWorlds.chr"
